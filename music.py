...
main_application.title('AB Music Player')
main_application.geometry('600x600')


status_bar_label = ttk.Label(main_application, text = 'Welcome To AB Music Player', relief = GROOVE, borderwidth = 2, font = ('Times New Roman', 15, 'italic'))
...
music_player_icon = PhotoImage(file = 'icon/AB Media Player Resized.png') # In About Us Section
...
def aboutus_func():
    ...
    text = ttk.Label(about_us_dialog, text = 'AB Music Player', font = ('Times New Roman', 28, 'bold'))
    text.pack(side = TOP)

    text1 = ttk.Label(about_us_dialog, text = 'An Indian Company', font = ('Times New Roman', 14))
    text1.pack(side = TOP)

    text2 = ttk.Label(about_us_dialog, text = 'AB Music Player is a free open source platform for \nmusic made by Abhay Biramane\n\nAB Music Player can read almost all music files and \nformats\n\nFor any queries contact - abhayb246@gmail.com', font = ('Times New Roman', 12))
    text2.pack(side = TOP)
